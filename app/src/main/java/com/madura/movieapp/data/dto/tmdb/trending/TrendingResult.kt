...
data class TrendingResult(
    ...
    override fun toString(): String {
        return "TrendingResult(adult=$adult, backdrop_path='$backdrop_path', first_air_date='$first_air_date', genre_ids=$genre_ids, id=$id, media_type='$media_type', name='$name', origin_country=$origin_country, original_language='$original_language', original_name='$original_name', original_title='$original_title', overview='$overview', popularity=$popularity, poster_path='$poster_path', release_date='$release_date', title='$title', video=$video, vote_average=$vote_average, vote_count=$vote_count)"
    }
}